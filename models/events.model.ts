...
class Events {
  ...
  async create() {
    try {
      const tableQuery =
        "CREATE TABLE IF NOT EXISTS events (eventId VARCHAR(45) NOT NULL PRIMARY KEY, eventTitle TEXT NOT NULL, eventDate TEXT NOT NULL, status ENUM('0', '1', '2', '3', '4', '5') NOT NULL DEFAULT '0', eventImageBanner LONGTEXT NOT NULL, eventImagePlaque TEXT NOT NULL, eventImageOne LONGTEXT NOT NULL, eventImageTwo TEXT NOT NULL, eventImageThree TEXT NOT NULL, eventDetailsShortDescription TEXT NOT NULL, eventDetailsLongDescription TEXT NOT NULL, partnerUUID VARCHAR(45) NOT NULL, likes INT NOT NULL, tags TEXT NOT NULL, napaPerks TEXT NOT NULL, eventRules TEXT NOT NULL, entryFees TEXT NOT NULL, address TEXT NOT NULL, address1 TEXT NOT NULL, city TEXT NOT NULL, state TEXT NOT NULL, zipCode TEXT NOT NULL, country TEXT NOT NULL, sponsors TEXT NOT NULL, paid TEXT NOT NULL, amount DECIMAL(19,2) NOT NULL, txid TEXT NOT NULL, createdAt TIMESTAMP NOT NULL DEFAULT NOW(), updatedAt TIMESTAMP NOT NULL DEFAULT NOW() ON UPDATE now(), FOREIGN KEY (partnerUUID) REFERENCES partners (partnerUUID))";
